#Juego original de donde proviene el crea laberintos 2000
...
while True:
    ...
    surface.blit(text_font.render('score:', True, pygame.Color('forestgreen'), True), (WIDTH + 50, 250))
    surface.blit(font.render(f'{score}', True, pygame.Color('forestgreen')), (WIDTH + 70, 300))
    surface.blit(text_font.render('record:', True, pygame.Color('magenta'), True), (WIDTH + 30, 460))
    surface.blit(font.render(f'{record}', True, pygame.Color('magenta')), (WIDTH + 70, 500))
